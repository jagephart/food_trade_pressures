...
Read in dfs
```{r}
grains <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_grains_used_as_feed_gapfilled.csv")
pulses <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_pulses_used_as_feed_gapfilled.csv")
oils <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_oilcrops_used_as_feed_gapfilled.csv")
soy <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_soy_used_as_feed_gapfilled.csv")
pk <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_palm_kernel_used_as_feed_gapfilled.csv")
```
...
# save csv
write_csv(feed_3, "scripts/feed_in_trade_matrix/outputs/all_crops_perc_feed.csv")
```
