---
title: "connect_2017_fish_trade_to_pressures"
...
- We are ignoring the intermediate countries for now, only grouping the source country (production pressures) and end country (consumption pressuers)
