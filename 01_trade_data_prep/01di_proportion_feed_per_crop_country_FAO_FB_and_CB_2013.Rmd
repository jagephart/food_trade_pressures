...
Next:
- calculate proportion cottonseed DSQ going to processing (cotton DSQ / cotton processing)
- calculate proportion cotton DSQ directly going to feed (cotton feed / cotton DSQ)

Reminder: we use CB instead of FB because the FB rounds to the nearest thousandth but they are otherwise the same values for 
```{r}
