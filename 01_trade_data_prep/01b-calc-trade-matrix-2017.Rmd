...
primary.data <- trade.data %>%
  group_by(Consumer_Country_Code, Producer_Country_Code, Year, primary_item) %>% # () removed because of averaging
...
test <- fread("raw_data/kastner_2022/Production_Crops_E_All_Data_(Normalized).csv")
table(test$Item)
