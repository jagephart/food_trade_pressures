...
- calculate proportion soy DSQ going to processing (soy processing / soy DSQ)
...
```{r}
fb <- read_csv("/home/shares/food-systems/social_justice_projects/_raw_data/FAO/FoodBalanceSheetsHistoric_E_All_Data_(Normalized)/FoodBalanceSheetsHistoric_E_All_Data_(Normalized).csv") %>% 
  filter(Year == 2013)
...
```{r}
cb <- read_csv("/home/shares/food-systems/social_justice_projects/_raw_data/FAO/CommodityBalances_(non-food)_E_All_Data_(Normalized)/CommodityBalances_(non-food)_E_All_Data_(Normalized).csv") %>% 
  filter(Year == 2013)
```
...
# save soy df
write_csv(soy_fb_cb_5, "scripts/feed_in_trade_matrix/outputs/perc_dsq_soy_used_as_feed.csv")
```
...
# save df
write_csv(pk_3_clean, "scripts/feed_in_trade_matrix/outputs/perc_dsq_palm_kernel_used_as_feed.csv")
```
...
# save df
write_csv(cotton_fb_cb_5, "scripts/feed_in_trade_matrix/outputs/perc_dsq_cotton_used_as_feed.csv")
```
...
# save df
write_csv(nut_fb_cb_5, "scripts/feed_in_trade_matrix/outputs/perc_dsq_groundnut_used_as_feed.csv")
```
...
# save df
write_csv(other_oil_fb_cb_5, "scripts/feed_in_trade_matrix/outputs/perc_dsq_other_oil_used_as_feed.csv")
```
...
# save df
write_csv(mustard_fb_cb_5, "scripts/feed_in_trade_matrix/outputs/perc_dsq_rapemustard_used_as_feed.csv")
```
...
# save df
write_csv(sesame_fb_cb_5, "scripts/feed_in_trade_matrix/outputs/perc_dsq_sesame_used_as_feed.csv")
```
...
# save df
write_csv(sunflower_fb_cb_5, "scripts/feed_in_trade_matrix/outputs/perc_dsq_sunflower_used_as_feed.csv")
```
...
sunflower <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_sunflower_used_as_feed.csv")
sesame <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_sesame_used_as_feed.csv")
rapemustard <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_rapemustard_used_as_feed.csv")
other_oil <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_other_oil_used_as_feed.csv")
groundnut <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_groundnut_used_as_feed.csv")
cotton <- read_csv("scripts/feed_in_trade_matrix/outputs/perc_dsq_cotton_used_as_feed.csv")
...
# save csv
write_csv(oils, "scripts/feed_in_trade_matrix/outputs/perc_dsq_oilcrops_used_as_feed.csv")
```
