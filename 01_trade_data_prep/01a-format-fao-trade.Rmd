...
na_values <- trade_matrix %>% 
  filter(Year == 2017) %>% 
  filter(is.na(Value))
table(na_values$Unit) # look at tonnes quantity
...
write_csv(trade_df, paste0(save_path,"Trade_2017_DetailedTradeMatrix_Gapfilled_7_14_22_formatted.csv"))
