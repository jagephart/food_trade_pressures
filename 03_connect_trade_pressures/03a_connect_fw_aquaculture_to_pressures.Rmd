...
fw_trade_pressures <- fw_trade_pressures %>% 
  ...
  # select columns to make smaller
  select(consumer_iso3c, source_country_iso3c, nceas_group, consumption_live_weight_t, pressure, pressure_per_tonne, pressure_total)
```
