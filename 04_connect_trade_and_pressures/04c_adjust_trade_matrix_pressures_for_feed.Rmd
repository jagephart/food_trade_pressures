...
summary(non_feed_crops_trade_pressures) # no NAs
...
# rbind dfs together
trade_matrix_w_pressures_accounting_for_feed <- rbind(non_feed_crops_trade_pressures, animal_feed_pressures_trade_for_final, livestock_fish_trade_pressures_for_final)
