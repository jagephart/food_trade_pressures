...
FOFM trade is currently all from trade code 230120 which is specified as "unfit for human consumption." Therefore we will assume that all FOFM is currently used for feed of livestock and fish. 
...
### Stopped here, looks like there are duplicates of trade we need to sum
...
# rbind dfs together
trade_matrix_w_pressures_accounting_for_feed <- rbind(non_feed_crops_trade_pressures_for_final, animal_feed_pressures_trade_for_final, livestock_fish_trade_pressures_for_final)

# check data - exclude FOFM for now because we are determining how to procede with feed allocation
