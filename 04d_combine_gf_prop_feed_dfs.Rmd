...
feed_4b_path <- "/home/shares/food-systems/social_justice_projects/food_trade_pressures/output_data/04b_gapfill_perc_feed_soy_palm_oilcrops_2013_CB_FB/"
feed_4c_path <- "/home/shares/food-systems/social_justice_projects/food_trade_pressures/output_data/04c_calc_prop_feed_pulses_grains_2017_FAO_FB/"
save_path <- "/home/shares/food-systems/social_justice_projects/food_trade_pressures/output_data/04d_combine_gf_prop_feed_dfs/"
```


Read in dfs
```{r}
grains <- read_csv(paste0(feed_4c_path, "perc_dsq_grains_used_as_feed_gapfilled.csv"))
pulses <- read_csv(paste0(feed_4c_path, "perc_dsq_pulses_used_as_feed_gapfilled.csv"))
oils <-   read_csv(paste0(feed_4b_path, "perc_dsq_oilcrops_used_as_feed_gapfilled.csv"))
soy <-    read_csv(paste0(feed_4b_path, "perc_dsq_soy_used_as_feed_gapfilled.csv"))
pk <-     read_csv(paste0(feed_4b_path, "perc_dsq_palm_kernel_used_as_feed_gapfilled.csv"))
```
