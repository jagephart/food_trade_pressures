...
save_path <- "/home/shares/food-systems/social_justice_projects/food_trade_pressures/output_data/01f_fofm_fw_aquaculture_feed/"
```
...
## Calculate FW Aquaculture Production
```{r}
...
# calculate production by each country for each group
fw_production <- fw_trade_clean %>% 
