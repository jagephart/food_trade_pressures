...
It was provided by Mel and will require better referencing in the methods section. The tonnes column represents the tonnes of live weight consumed of the Fish that make up FOFM.
```{r}
