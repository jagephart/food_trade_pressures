...
reporting.data.file <- "raw_data/Code/Reporting_Dates.xls"
...
### Primary item data
# specify name of file and file path you want to read in
item.map.file <- "raw_data/Code/primary_item_map_feed.csv"
...
##Conversion factors
# specify name of file and file path you want to read in
content.factors.file <- "raw_data/Code/content_factors_per_100g.xlsx"
