...
fao_data_path <- paste0(raw_folder_path, "2017_FAO_data/")
save_path <- "/home/shares/food-systems/social_justice_projects/food_trade_pressures/output_data/01-format-fao-trade/"
```
...
h_trade_matrix <- fread(paste0(fao_data_path, "Trade_DetailedTradeMatrix_E_All_Data_(Normalized)_7_14_22.csv"))
